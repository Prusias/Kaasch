<?php
    ...
    function create_order($mysqli, $addresses_id) {
        ...
        $mysqli->query("INSERT INTO orders (user_id, date, status_id, paymentmethod_id, is_paid, addresses_id) VALUES ({$user_id}, NOW(), 1, 1, 0, {$addresses_id});");
